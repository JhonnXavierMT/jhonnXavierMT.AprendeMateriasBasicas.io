...
$diccionario = [
    ...
    "MESA DE PRUEBAS"        => "PROTOBOARD",
    "PALA"                   => "SHOVEL",
    "NIVEL DE MANO"          => "SPIRIT LEVEL",
    "PALANCA TERMICA"        => "CIRCUIT BREAK",
    "CAJA"                   => "BOX",
    "PATA CABRA"             => "CROWBAR",
    "PASTA DE SOLDAR"        => "SOLDERING PASTE",
    "SERRUCHO"               => "HAND SAW",
    "TUBO"                   => "PIPE",
    "DISCO DE AMULADORA"     => "GRINDING WHEEL",
    "MARTILLO"               => "HAMMER",
    "FLEXO"                  => "TAPE MEASURE",
    "PISTOLA DE SOLDAR"      => "SOLDERING GUN",
