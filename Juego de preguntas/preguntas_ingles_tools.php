...
$diccionario = [
    ...
    "CLAVO"                  => "NAIL",
    "PRENSA"                 => "CLAMP",
    "ALICATE DE CORTE"       => "DIAGONAL CUTTING PLIERS",
    "ALICATE DE PUNTA"       => "LONG NOSE PLIERS",
    "ALICATE DE FUERZA"      => "COMBINATION PLIERS",
    "AMULADORA ANGULAR"      => "ANGLE GRINDER",
    "AMULADORA VERTICAL"     => "STRAIGHT",
    "TALADRO INALAMBRICO"    => "ELECTRIC CORDLESS DRILL",
    "TALADRO ELECTRICO"      => "ELECTRIC DRILL",
    "LLAVE AJUSTABLE"        => "ADJUSTABLE WRENCH",
    "LLAVE ESTILSON"         => "MONKEY WRENCH",
    "LLAVE MANDRIL"          => "DRILL CHUCK KEY",
    "DESTORNILLADOR PLANO"   => "SCREW DRIVER",
    "DESTORNILLADOR ESTRELLA"=> "PHILLIPS SCREDRIVER",
    "MULTIMETRO DIGITAL"     => "DIGITAL MULTIMETER",
    "MOTOCIERRA"             => "CHAINSAW",
    "MULTIMETRO DE GANCHO"   => "DIGITAL CLAMP METER",
    "BROCA"                  => "DRILL BIT"
];
