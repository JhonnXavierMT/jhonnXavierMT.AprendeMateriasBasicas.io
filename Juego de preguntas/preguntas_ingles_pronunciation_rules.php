...
$diccionario = [
    "Cuando la palabra termina en 'al' Example: small, tall, call. ¿Por que vocal se remplaza 'al'? " => "o",
    "Cuando la palabra contiene la silaba en 'gh' Example: night, fight. ¿como se le considera? " => "silenciosa",
    "Cuando la palabra termina en 'le' Example: table, google, moodle. ¿Por que silaba se remplaza 'le'? " => "ol",
    "Cuando al inicio de una palabra tiene 'wr' Example: write, wrong, wrench. ¿Por que letra se remplaza  'wr'? " => "r",
    "¿Como se proncia la 'U' en una palabra de ingles?"=>"a"
];
